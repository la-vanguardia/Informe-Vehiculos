...
\begin{document}
    ...
    Al observar la Fig.\ref{fig:resultados2} se puede concluir que los resultados son precisos, al compararlos con la
    ...
    logra un desempeño aceptable. Por otro lado, en la Fig.\ref{fig:real-results} donde se analiza a la red con imágenes reales,
